                ...
                <div className="cardEDR-body">
                  ...
                  <div className="profilEDR-form-grid">
                    <div className="profilEDR-field">
                      ...
                      <input id="username" className="inputEDR" value={userInfo.username} />
                    </div>

                    <div className="profilEDR-field">
                      <label htmlFor="email" className="labelEDR">Email</label>
                      <input id="email" className="inputEDR" type="email" value={userInfo.email} />
                    </div>

                    <div className="profilEDR-field">
                      <label htmlFor="bio" className="labelEDR">Bio</label>
                      <textarea id="bio" className="textareaEDR" rows="3" placeholder="Tell us about yourself..." defaultValue={userInfo.bio}></textarea>
                    </div>
                  </div>

                  <button className="btnEDR-primary">Save Changes</button>
                </div>
              </div>
            </div>
          </div>
